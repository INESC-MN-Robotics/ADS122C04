...
bool only_once = true; //stops the codeblock in loop() from running after one instance //
...
void loop() {
 ...
 if(only_once == true){
    ...
    adc_L00.powerdown();
    adc_R11.powerdown();
    only_once = false; // Locks the above block of code up //
 }

        //Prints the value of R_11 CH0, seen as the loop was restarted before the for loop was closed//
