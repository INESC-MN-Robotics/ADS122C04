...
void loop() {
  ...
  Byte3 resultl0, resultl1, resultl2, resultl3, resultr0, resultr1, resultr2, resultr3;
  ...
  int delay_r = 50;
      ...
      //---------------------------------------R_11-CH0 (restart the loop)---------------------------------------
        ...
        Serial.println(resultl0.code * 2.048*1000/8388608.6);
        Serial.println(resultl1.code * 2.048*1000/8388608.6);
        Serial.println(resultl2.code * 2.048*1000/8388608.6);
        Serial.println(resultl3.code * 2.048*1000/8388608.6);
        Serial.println(resultr0.code * 2.048*1000/8388608.6);
        Serial.println(resultr1.code * 2.048*1000/8388608.6);
        Serial.println(resultr2.code * 2.048*1000/8388608.6);
        Serial.println(resultr3.code * 2.048*1000/8388608.6);
}
